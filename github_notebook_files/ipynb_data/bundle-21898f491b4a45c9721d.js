...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("21898f491b4a45c9721d")
/******/ 	})();
/******/ 	
...
var core = __webpack_require__(33390);
...
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || highlight_unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
var commonLanguages = {
  python: function python() {
    return __webpack_require__.e(/* import() */ 5037).then(__webpack_require__.bind(__webpack_require__, 75037));
  },
  ruby: function ruby() {
    return __webpack_require__.e(/* import() */ 7271).then(__webpack_require__.bind(__webpack_require__, 47271));
  },
  javascript: function javascript() {
    return __webpack_require__.e(/* import() */ 9622).then(__webpack_require__.bind(__webpack_require__, 99622));
  },
  bash: function bash() {
    return __webpack_require__.e(/* import() */ 6167).then(__webpack_require__.bind(__webpack_require__, 66167));
  },
  sql: function sql() {
    return __webpack_require__.e(/* import() */ 4085).then(__webpack_require__.bind(__webpack_require__, 34085));
  },
  julia: function julia() {
    return __webpack_require__.e(/* import() */ 5246).then(__webpack_require__.bind(__webpack_require__, 95246));
  },
  perl: function perl() {
    return __webpack_require__.e(/* import() */ 3049).then(__webpack_require__.bind(__webpack_require__, 63049));
  },
  r: function r() {
    return __webpack_require__.e(/* import() */ 140).then(__webpack_require__.bind(__webpack_require__, 10140));
  }
};
...
function html_sanitizer_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function html_sanitizer_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { html_sanitizer_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { html_sanitizer_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
function sanitizeContent() {
  ...
  var sanitized = purify_default().sanitize(content, {
...
function height_tracker_createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = height_tracker_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
function height_tracker_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return height_tracker_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return height_tracker_arrayLikeToArray(o, minLen); }
function height_tracker_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
function height_tracker_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function origin_parser_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function origin_parser_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
function origin_parser_createClass(Constructor, protoProps, staticProps) { if (protoProps) origin_parser_defineProperties(Constructor.prototype, protoProps); if (staticProps) origin_parser_defineProperties(Constructor, staticProps); return Constructor; }
function origin_parser_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var IframeMessenger = /*#__PURE__*/function () {
  ...
  iframe_createClass(IframeMessenger, [{
    ...
    value: function init() {
      var _this = this;
      if (_classPrivateFieldGet(this, _listening)) {
      ...
      _classPrivateFieldSet(this, _handshakeInterval, setInterval(function () {
        if (_classPrivateFieldGet(_this, _handshakeInterval) !== false && (_classPrivateFieldGet(_this, _initialAck) || attempts === 0)) {
          clearInterval(_classPrivateFieldGet(_this, _handshakeInterval));
          return;
        }
    ...
    key: "didAck",
    value: function didAck() {
      return _classPrivateFieldGet(this, _initialAck);
    }
  }, {
    key: "on",
    value: function on(eventName, callback) {
      return _classPrivateFieldGet(this, _eventBus).on(eventName, callback);
    }
  }]);
...
function _receive2(event) {
  ...
  if (body.cmd === ACK) {
    ...
    _classPrivateFieldGet(this, _eventBus).emit(body.cmd, body.payload);
  }
}
...
/******/ })()
;
//# sourceMappingURL=bundle-21898f491b4a45c9721d.js.map